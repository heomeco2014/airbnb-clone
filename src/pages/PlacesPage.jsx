        ...
        <div>
            {action !== 'new' && (
                <div className="text-center">
                    <Link className="mx-auto inline-flex items-center gap-1 rounded-full bg-primary px-4 py-2 text-white" to={'/account/places/new'}>
            ...
            {action === 'new' && (
                <div className="">
                    <form>
                        ...
                        <input type="text" placeholder="title, example: My home" value={title} onChange={(e) => setTitle(e.target.value)} />
                        {preInput('Address', 'Address of your place, should be real address')}
                        <input type="text" placeholder="address" value={address} onChange={(e) => setAddress(e.target.value)} />

                        {preInput('Photos', 'More = better')}
                        <div className="flex items-center gap-2">
                            <input type="text" placeholder="Add using a link" className="" value={photoLinks} onChange={(e) => setPhotoLinks(e.target.value)} />
                            <button className="w-[7%] rounded-2xl bg-gray-300 px-4 py-2 text-black" onClick={addPhotoByLink}>
                                Add photo
                            </button>
                        </div>
                                ...
                                addedPhotos.map((photo) => {
                                    return (
                                        <div className="flex h-32">
                                            <img className="w-full rounded-2xl object-cover" src={'http://localhost:4000/uploads/' + photo} />
                                        </div>
                                    )
                                })}
                        ...
                        <textarea className="" value={extraInfor} onChange={(e) => setExtraInfor(e.target.value)}></textarea>
                        ...
                        <div className="grid gap-2 sm:grid-cols-3">
                            <div className="">
                                ...
                                <input type="time" className="" placeholder="13:00" value={checkIn} onChange={(e) => setCheckIn(e.target.value)} />
                            </div>
                            <div className="">
                            ...
                            <div className="">
                                ...
                                <input type="number" min={0} max={100} value={maxGuests} onChange={(e) => setMaxGuests(e.target.value)} />
                            </div>
                        </div>
